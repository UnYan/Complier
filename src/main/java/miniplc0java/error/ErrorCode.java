...
public enum ErrorCode {
    ...
    NotDeclared, AssignToConstant, DuplicateDeclaration, NotInitialized, InvalidAssignment, InvalidPrint, ExpectedToken, MismatchedAssignmentType,
    NotOperator,NoFunction,ParamsOutOfRange,ParamTypeMismatched,MinusString
}
